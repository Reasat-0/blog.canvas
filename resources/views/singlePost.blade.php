                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <article class="hentry post post-standard-details">
                        ...
                        <div class="post-thumb text-center" >
                            <img src="{{ $singlePost->featured }}" alt="seo">
                        </div>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <p class="post__subtitle"> {{ $singlePost-> content}}</p>
                    ...
                    <div class="pagination-arrow">
                        @if($nextPost)
                            ...
                            <a href="{{ route('post.single',['slug'=> $nextPost->slug]) }}" class="btn-next-wrap">
                        ...
                        @if($prevPost)
                                ...
                                <a href="{{ route('post.single',['slug'=> $prevPost->slug]) }}" class="btn-prev-wrap">
                                    <svg class="btn-prev">
